...
7. Frontend: navigation is Work Queue / Development Progress / Test Evidence /
   ...
   / AI Assisted** framing.
8. Missing docs (§35): build-review-artifact-model.md, developer-workspace-model.md,
   git-publication-model.md, build-review-state-machine.md, build-review-demo-script.md.
...
- Engine `build.summary` + `build.quality_handoff` assembly; demo macros;
  docs §35 (build-review-artifact-model.md, developer-workspace-model.md, git-publication-model.md,
  build-review-state-machine.md, build-review-demo-script.md); CLAUDE.md + AGENTS.md
