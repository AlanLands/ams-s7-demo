...
**Deck:** `docs/slide-decks/intake-storyboard-animated.html` (20 slides, animated beats)
...
2. Open the deck (`docs/slide-decks/intake-storyboard-animated.html`) in its own window,
...
4. Have the requirement source ready:
   - **Simulation:**
     `requirements/sample-documents/MapleSure-Disability-Claim-Submission-Requirement.pdf`
   ...
   - **Live:** the rehearsed requirement text from
     `docs/presenter-guides/live-mode-end-to-end-guide.md` § Step 2, ready to paste **verbatim** —
...
`docs/presenter-guides/live-mode-end-to-end-guide.md` is the full script for that. To keep live
