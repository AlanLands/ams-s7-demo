---
id: staged-assessment-task
layer: task
title: Staged pipeline — assessment task
stage: assess
summary: The staged pipeline's assessment prompt: route the epic into stream-classified tasks with honest coverage.
variables: epic_body, streams
---
